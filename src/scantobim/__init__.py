"""ScanToBIM â€” reconstruct clean-edged 3D models from LiDAR point clouds and photos.

The package implements a structured scan-to-model pipeline:

1.  Ingest point clouds from LAS/LAZ, PLY, PCD, E57, XYZ/PTS/CSV â€” or a dense
...
5.  Extract crisp boundary polygons per plane (alpha shape â†’ simplification â†’
